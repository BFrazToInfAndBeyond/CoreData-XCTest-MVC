...
@interface MFFavoritedSearchViewController ()
...
@implementation MFFavoritedSearchViewController
...
- (void)loadView
{
    ...
    MFFavoritedSearchModel *searchModel = [[MFFavoritedSearchModel alloc] initWithServiceClientFactory:serviceClientFactory persistenceFactory:self.persistenceFactory persistencePonsoProvider:persistencePonsoProvider memoryStack:memoryStack];
